...
class Stone(Object2D):
    ...
    def split_stone(self):
        ...
        self.game_state.add_object(Stone(self.pos, (vel_x * weight_a, vel_y * weight_a), (self.size // consts.STONE_BASE_RADIUS) - 1))
        self.game_state.add_object(Stone(self.pos, (-vel_x * (1 - weight_a), vel_y * (1 - weight_a)), (self.size // consts.STONE_BASE_RADIUS) - 1))
